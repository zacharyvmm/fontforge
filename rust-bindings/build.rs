...
fn main() {
    ...
    let bindings = bindgen::Builder::default()
        ...
        // Namelist functions (RALPH-022)
        .allowlist_type("NameList")
        .allowlist_type("namelist")
        .allowlist_function("UniFromName")
        .allowlist_function("StdGlyphName")
        .allowlist_function("StdGlyphNameBoundsCheck")
        .allowlist_function("DefaultNameListForNewFonts")
        // Unicode type data functions (RALPH-023)
        .allowlist_function("ff_unicode_.*")
        .allowlist_function("arabicform")
        // Unicode name functions
        .allowlist_function("uniname_.*")
        .allowlist_type("arabicforms")
        .allowlist_type("unicode_range")
